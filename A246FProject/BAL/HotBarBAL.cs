...
namespace A246FProject.BAL
{
    public class HotBarBAL
    {
        ...
        public DataTable GetHotBarData(
            int projectId,
            int lineId)
        {
            return _dal.GetHotBarData(projectId, lineId);
        }
        ...
        public int InsertBulkA246FMHB1CheckList(
            DataTable dt,
            int lineId,
            int projectId,
            int modelId,
            ...
            string createdBy)
        {
            return _dal.InsertBulkA246FMHB1CheckList(
