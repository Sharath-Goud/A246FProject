...
{
    public class CTQOperatorViewModel
    {
        ...
        public List<CTQOperatorResult> CTQOperatorResults { get; set; }
            = new List<CTQOperatorResult>();

        public string CreatedBy { get; set; }
    }


    public class CTQOperatorResult
    {
    ...
    public class CTQOperatorBulkForm
    {
        public int LineId { get; set; }
